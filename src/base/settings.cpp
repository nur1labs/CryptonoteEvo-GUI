...
constexpr char DEFAULT_WORK_DIR[] = ".cryptonote";
#endif

const constexpr char* DEFAULT_MINING_POOLS[] = { "pool.cryptonote.party:3333", "cryptonote.uk:3333", "cryptonote-pool.org:3333", "bcn.pool.minergate.com:45550" };
...
Settings::Settings()
{
    ...
    const QString jsonFile = getDefaultWorkDir().absoluteFilePath("cryptonote-gui.config");
